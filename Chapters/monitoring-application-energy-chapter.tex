...
The functional design of a system to estimate energy allocation for application requests (which we have dubbed "Apollo" - the Greek God of Prophesy, amongst other things) is shown in the informal block diagram in \ref{figure:logicaldesign}.
