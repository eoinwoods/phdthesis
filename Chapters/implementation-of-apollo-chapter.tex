...
I haven't put in the PUE factor due to time constraints.  Could possibly squeeze in during September, but for now need to acknowledge it as a limitation, future work ...

Batch offline operation - would need more work to be stream based.
